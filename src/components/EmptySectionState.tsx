...
export const EmptySectionState = ({
	...
	return (
		<div className="flex flex-col items-center justify-center text-center py-10 px-6 border-2 border-dashed border-gray-200 dark:border-gray-800 rounded-xl bg-gray-50/30 dark:bg-gray-900/10 transition-all duration-300 hover:border-primary/20 hover:bg-gray-50/50 dark:hover:bg-gray-900/20 group">
			...
			<p className="text-xs text-gray-500 dark:text-gray-400 mb-6 max-w-[280px] leading-relaxed">
				{description}
			</p>
			<Button
				onClick={onClick}
